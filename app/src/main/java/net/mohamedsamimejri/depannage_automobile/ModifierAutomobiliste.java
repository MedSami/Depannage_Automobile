...
public class ModifierAutomobiliste extends Activity {
	public static final String strURL = "http://10.0.3.2:8080/Tunisie_Telecom/ModifierAutomobiliste.php";
	public static final String strURL1 = "http://10.0.3.2:8080/Tunisie_Telecom/SelectAutomobiliste.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.modifierautomobiliste);
	...
	private class Task extends AsyncTask<Void, Void, JSONArray> {
		...
		protected JSONArray doInBackground(Void... params) {
			...
			try {
				...
				Toast.makeText(getApplicationContext(),
						"Erreur Analyse de donn�e", Toast.LENGTH_SHORT).show();
			}
		...
		protected void onPostExecute(JSONArray result) {
			...
			if (result == null) {
				Toast.makeText(getApplicationContext(),
						"Aucune donn�e obtenir", Toast.LENGTH_SHORT).show();
			}
			try {
