...
public class AjouterAutomobiliste extends Activity {
	public static final String strURL = "http://10.0.3.2:8080/Tunisie_Telecom/AjoutAutomobiliste.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ajouterautomobiliste);
			...
			public void onClick(View arg0) {
				if (cin.getText().toString().equals("")) {
					...
					AlertDialog.Builder adb = new AlertDialog.Builder(
							AjouterAutomobiliste.this);
					adb.setTitle("V�rifier");
					adb.setMessage("saisir Nom & Pr�nom Automobiliste");
					adb.setPositiveButton("Ok", null);
					adb.show();
