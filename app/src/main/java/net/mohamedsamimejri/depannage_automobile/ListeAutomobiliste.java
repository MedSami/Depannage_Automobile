...
public class ListeAutomobiliste extends ListActivity {
	public static final String strURL = "http://10.0.3.2:8080/Tunisie_Telecom/SelectToutAutomobiliste.php";
	public static final String strURL1 = "http://10.0.3.2:8080/Tunisie_Telecom/SupprimerAutomobiliste.php";
	public static final String strURL2 = "http://10.0.3.2:8080/Tunisie_Telecom/SelectAutomobiliste.php";
	public static final String strURL3 = "http://10.0.3.2:8080/Tunisie_Telecom/SelectPositionAutomobiliste.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listeautomobiliste);
	...
	private class AppelerAuto extends AsyncTask<Void, Void, JSONArray> {
		...
		protected JSONArray doInBackground(Void... params) {
			...
			try {
				...
				Toast.makeText(ListeAutomobiliste.this,
						"Erreyr Analyse de donn�e ", Toast.LENGTH_LONG).show();
			}
		...
		protected void onPostExecute(JSONArray result) {
			...
			try {
				...
				Log.e("log_tag", "Erreur Analyse de donn�e" + e.toString());
			}
		}
	...
	private class LocaliserAuto extends AsyncTask<Void, Void, JSONArray> {
		...
		protected JSONArray doInBackground(Void... params) {
			// TODO Auto-generated method stub
			JavaScriptOrientedNotation js = new JavaScriptOrientedNotation(
					strURL3, NumeroCinAutomobiliste, null, null, null, null,
					null, null, null, null, null);
