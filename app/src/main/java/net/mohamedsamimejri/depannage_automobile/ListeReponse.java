...
public class ListeReponse extends ListActivity {
	public static final String strURL = "http://10.0.3.2:8080/Tunisie_Telecom/SelectReponse.php";
	ListView maList;
	InputStream is = null;
	JSONArray ar;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listereponse);
		...
		protected void onPostExecute(JSONArray result) {
			...
			if(result==null){
				AlertDialog.Builder adb = new AlertDialog.Builder(
						ListeReponse.this);
				adb.setTitle("Info");
				adb.setMessage("Aucune R�ponse disponible");
