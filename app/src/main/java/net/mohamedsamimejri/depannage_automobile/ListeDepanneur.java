...
public class ListeDepanneur extends ListActivity {
	public static final String strURL = "http://10.0.3.2:8080/Tunisie_Telecom/SelectToutDepanneur.php";
	public static final String strURL2 = "http://10.0.3.2:8080/Tunisie_Telecom/SupprimerDepanneur.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listedepanneur);
		...
		protected void onPostExecute(JSONArray result) {
			...
			try {
				...
				for (int i = 0; i < result.length(); i++) {
					...
					Depanneur[i] = "Cin D�panneur :" + c + " Nom Pr�nom:" + np;
				}
		...
		protected JSONArray doInBackground(Void... params) {
			...
			try {
				...
				try {
					...
					Toast.makeText(ListeDepanneur.this,
							"Erreur Analyse de donn�e", Toast.LENGTH_LONG)
							.show();
				}
			return ar;
		}
