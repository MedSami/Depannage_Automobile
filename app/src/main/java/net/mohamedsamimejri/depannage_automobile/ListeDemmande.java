...
public class ListeDemmande extends ListActivity {
	public static final String strURL = "http://10.0.3.2:8080/Tunisie_Telecom/SelectDemmande.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listedemmande);
	...
	private class SelectDemmande extends AsyncTask<Void, Void, JSONArray> {
		...
		protected JSONArray doInBackground(Void... params) {
			...
			try {
				...
				Toast.makeText(ListeDemmande.this, "Erreur Analyse de donn�e",
						Toast.LENGTH_LONG).show();
			}
