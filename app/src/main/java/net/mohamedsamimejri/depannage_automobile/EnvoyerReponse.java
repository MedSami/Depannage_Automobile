...
public class EnvoyerReponse extends Activity {
	public static final String strURL1 = "http://10.0.3.2:8080/Tunisie_Telecom/AjoutReponse.php";
	public static final String strURL = "http://10.0.3.2:8080/Tunisie_Telecom/SelecteDemmande.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.envoyerreponse);
	...
	private class SelectDemmande extends AsyncTask<Void, Void, JSONArray> {
		...
		protected JSONArray doInBackground(Void... params) {
			...
			try {
				...
				Toast.makeText(EnvoyerReponse.this, "Erreur Analyse de donn�e",
